...
if("TRUE" STREQUAL "TRUE")
  set(rf2o_laser_odometry_SOURCE_PREFIX /home/ros-autocar/ROS-Autocar/src/rf2o_laser_odometry)
  set(rf2o_laser_odometry_DEVEL_PREFIX /home/ros-autocar/ROS-Autocar/devel)
  ...
  set(rf2o_laser_odometry_INSTALL_PREFIX /home/ros-autocar/ROS-Autocar/install)
...
if(NOT "/home/ros-autocar/ROS-Autocar/src/rf2o_laser_odometry/include;/usr/include/eigen3 " STREQUAL " ")
  set(rf2o_laser_odometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/ros-autocar/ROS-Autocar/src/rf2o_laser_odometry/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros-autocar/ROS-Autocar/src/rf2o_laser_odometry/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rf2o_laser_odometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rf2o_laser_odometry")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rf2o_laser_odometry_NUM_DUMMY_TARGETS)
      set(rf2o_laser_odometry_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rf2o_laser_odometry::wrapped-linker-option${rf2o_laser_odometry_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rf2o_laser_odometry_NUM_DUMMY_TARGETS "${rf2o_laser_odometry_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rf2o_laser_odometry::wrapped-linker-option${rf2o_laser_odometry_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rf2o_laser_odometry_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rf2o_laser_odometry_EXPORTED_TARGETS ${${rf2o_laser_odometry_dep}_EXPORTED_TARGETS})
endforeach()
